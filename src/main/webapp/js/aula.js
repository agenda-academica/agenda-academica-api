...
var rootURL = "http://localhost:8080/agenda-academica-api/rest/aula";
...
function renderListaDeProva(data){
	...
	$.each(list, function(index, prova) {
		$('#listaDeProva').append('<li><a href="#" data-identity="' + prova.codigo + '">'+prova.descricao+'</a></li>');
	});
	//fim teste
